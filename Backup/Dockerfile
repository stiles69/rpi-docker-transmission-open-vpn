...
ENV OPENVPN_USERNAME=**None** \
    ...
    TRANSMISSION_SCRIPT_TORRENT_DONE_FILENAME=$HOME/development/Docker/docker-transmission-openvpn/transmission-extract.sh \
    ...
    TRANSMISSION_WATCH_DIR=/data/transmission-home \
